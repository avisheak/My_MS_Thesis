...
//		Methods.print(resultSet);
	...
	private void transformMultipleLiteral1(Model firstModel, Model secondModel, ConceptTransform conceptTransform,
			Model targetModel, int count, int numOfFiles) {
...
//		Methods.print(targetModel);
	...
	public Methods getFileMethods() {
		return fileMethods;
	}

	public void setFileMethods(Methods fileMethods) {
