...
//				  "ORDER BY ?admGeographyDim_administrativeUnitName ?residenceDim_residenceType ?housingTenancyDim_housingTenancyAll";
	...
	public OnDemandETL(String mapFile, String targetTBoxFile, String targetABoxString) {
		...
		setConceptMap(new LinkedHashMap<Integer, ConceptTransform>());
...
//		Methods.print(finalResultSet);
	...
	public LinkedHashMap<String, ArrayList<String>> checkRequiredLevels(Model targetABoxModel,
		...
		// TODO Auto-generated method stub
		LinkedHashMap<String, ArrayList<String>> requiredArrayList = new LinkedHashMap<String, ArrayList<String>>();
	...
	public LinkedHashMap<String, ArrayList<String>> extractRequiredLevels(String sparqlQueryString) {
		// TODO Auto-generated method stub
		LinkedHashMap<String, ArrayList<String>> requiredLevelsArrayList = new LinkedHashMap<String, ArrayList<String>>();
...
//		System.out.println(sparql);
	...
	public void setDatasetList(JList<?> datasetList) {
	...
	public LinkedHashMap<Integer, ConceptTransform> getConceptMap() {
		return conceptMap;
	}

	public void setConceptMap(LinkedHashMap<Integer, ConceptTransform> conceptMap) {
