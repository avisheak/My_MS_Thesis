...
//					}
	...
	private void okButtonHandler() {
		...
		for (@SuppressWarnings("unused") Boolean dummy : temp.getDataColumnsIsURL()) {
		}
	...
	private void loadDataColumns(String tableName) {
		...
		setSelectedTableIndex(allDBTableStructures.indexOf(dbTable));
	...
	public JTable getTableDBTables() {
		return tableDBTables;
	}

	public void setTableDBTables(JTable tableDBTables) {
		this.tableDBTables = tableDBTables;
	}

	public ArrayList<String> getTableStatus() {
		return tableStatus;
	}

	public void setTableStatus(ArrayList<String> tableStatus) {
