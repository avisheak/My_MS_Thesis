...
public class PanelOlap extends JPanel {
	...
	private JList<CheckListItem> listInstance;
	...
	private JList<String> listSelectionProperty;
	...
	public PanelOlap() {
		...
		comboBoxDataset = new JComboBox<String>();
		...
		listSchemaIRI = new JList<String>();
		...
		listSchemaGraph = new JList<String>();
		...
		listInstanceGraph = new JList<String>();
		...
		comboBoxProperty = new JComboBox<String>();
		...
		comboBoxFilterCondition = new JComboBox<String>();
		...
		listSelectionProperty = new JList<String>();
		...
		listInstance = new JList<CheckListItem>();
...
//				definition.runSparqlQuery(textAreaQuery.getText().toString().trim(), true);
	...
	protected void copyInstances() {
		...
		if (isEnabled) {
			...
			LinkedHashMap<String, SelectedLevelInstance> propertyMap = new LinkedHashMap<String, SelectedLevelInstance>();
			if (definition.getInstancesMap().containsKey(selectedLevel)) {
