...
public class ETLMatcher implements ETLOperation {
	...
	public boolean getInput(JPanel panel, HashMap<String, LinkedHashSet<String>> inputParamsMap) {
		...
		JComboBox<Object> comboBoxPWeightFile = new JComboBox<Object>();
		comboBoxPWeightFile.setFont(new Font("Tahoma", Font.PLAIN, 16));
		panelMatcher.add(comboBoxPWeightFile, "flowx,cell 2 1,growx");

		LinkedHashSet<String> pWeightFileHashSet = inputParamsMap.get(PROPERTY_WEIGHT_FILE);
		...
		JComboBox<Object> comboBoxDBpediaSBag = new JComboBox<Object>();
		comboBoxDBpediaSBag.setFont(new Font("Tahoma", Font.PLAIN, 16));
		panelMatcher.add(comboBoxDBpediaSBag, "flowx,cell 2 2,growx");

		LinkedHashSet<String> dbpediaSBagFileHashSet = inputParamsMap.get(SEMANTIC_BAG_FILE);
		...
		JComboBox<Object> comboBoxLocalKBSbagFilePath = new JComboBox<Object>();
		...
		LinkedHashSet<String> localKBSBagFileHashSet = inputParamsMap.get(SEMANTIC_BAG_FILE);
		...
		btnOpenDBPediaSBag.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (!filePath.equals("")) {
					...
					DefaultComboBoxModel<Object> comboBoxModel = (DefaultComboBoxModel<Object>) comboBoxDBpediaSBag.getModel();
		...
		btnOpenLKSBag.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (!filePath.equals("")) {
					...
					DefaultComboBoxModel<Object> comboBoxModel = (DefaultComboBoxModel<Object>) comboBoxLocalKBSbagFilePath.getModel();
					comboBoxModel.addElement(filePath);
		...
		btnOpenPWeightFile.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (!filePath.equals("")) {
					...
					DefaultComboBoxModel<Object> comboBoxModel = (DefaultComboBoxModel<Object>) comboBoxPWeightFile.getModel();
					comboBoxModel.addElement(filePath);
