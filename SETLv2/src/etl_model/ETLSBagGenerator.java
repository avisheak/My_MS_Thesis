...
public class ETLSBagGenerator implements ETLOperation {
	...
	private JComboBox<Object> comboBoxResourceFilePath, comboBoxRDFFilePath, comboBoxDBpediDataFilePath;
...
//				break;
	...
	public boolean getInput(JPanel panel, HashMap<String, LinkedHashSet<String>> inputParamsMap) {
		...
		JComboBox<Object> comboBoxOperation = new JComboBox<Object>();
		comboBoxOperation.setFont(new Font("Tahoma", Font.PLAIN, 16));
		comboBoxOperation.setModel(new DefaultComboBoxModel<Object>(new String[] { "Local KB Resource Semantic Bag Generation", "DBpedia Data Semantic Bag Generation" }));
		...
		comboBoxResourceFilePath = new JComboBox<Object>();
		...
		LinkedHashSet<String> resourceFilePathSet = inputParamsMap.get(RESOURCE_FILE);
...
//		}
		...
		btnOpenResourceFile.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (!filePath.equals("")) {
					...
					DefaultComboBoxModel<Object> comboBoxModel = (DefaultComboBoxModel<Object>) comboBoxDBpediDataFilePath.getModel();
		...
		comboBoxRDFFilePath = new JComboBox<Object>();
		...
		LinkedHashSet<String> rdfFileHashSet = inputParamsMap.get(RDF_FILE);
		...
		comboBoxDBpediDataFilePath = new JComboBox<Object>();
		...
		LinkedHashSet<String> dbPediaDataFileHashSet = inputParamsMap.get(DBPEDIA_DATA_FILE);
		...
		btnOpenRDFFile.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (!filePath.equals("")) {
					...
					DefaultComboBoxModel<Object> comboBoxModel = (DefaultComboBoxModel<Object>) comboBoxRDFFilePath.getModel();
					comboBoxModel.addElement(filePath);
