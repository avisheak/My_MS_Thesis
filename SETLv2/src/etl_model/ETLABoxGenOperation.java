...
public class ETLABoxGenOperation implements ETLOperation{
	...
	public boolean getInput(JPanel panel, HashMap<String, LinkedHashSet<String>> inputParamsMap) {
		...
		JComboBox<Object> comboBoxDBName = new JComboBox<Object>();
		...
		LinkedHashSet<String> dbNameSet = inputParamsMap.get(DB_NAME);
		...
		JComboBox<Object> comboBoxDBUserName = new JComboBox<Object>();
		...
		LinkedHashSet<String> dbUserNameSet = inputParamsMap.get(DB_USER_NAME);
		...
		JComboBox<Object> comboBoxDBPassword = new JComboBox<Object>();
		...
		JComboBox<Object> comboBoxMGFilePath = new JComboBox<Object>();
		comboBoxMGFilePath.setFont(new Font("Tahoma", Font.PLAIN, 16));
		panelMGInput.add(comboBoxMGFilePath, "flowx,cell 2 5,growx");
		
		LinkedHashSet<String> mappingGraphFileHashSet = inputParamsMap.get(MAPPING_GRAPH_FILE);
		...
		btnNewMGFile.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if(!filePath.equals("")){
					...
					DefaultComboBoxModel<Object> comboBoxModel = (DefaultComboBoxModel<Object>) comboBoxMGFilePath.getModel();
	...
	public DBConnection getDatabaseOperations() {
		return databaseOperations;
	}

	public void setDatabaseOperations(DBConnection databaseOperations) {
