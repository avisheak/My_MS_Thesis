...
public class ETLABox2TBox implements ETLOperation {
	...
	public boolean getInput(JPanel panel, HashMap<String, LinkedHashSet<String>> inputParamsMap) {
		...
		LinkedHashSet<String> sourceHashSet2 = inputParamsMap.get(EXPRESSION_FILE);
		LinkedHashSet<String> sourceHashSet3 = inputParamsMap.get(RDF_MAPPER);
		...
		LinkedHashSet<String> hashSet = inputParamsMap.get(TBox_FILE);
