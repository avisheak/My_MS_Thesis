...
public class ETLTBoxBuilder implements ETLOperation {
	...
	public boolean getInput(JPanel panel, HashMap<String, LinkedHashSet<String>> inputParamsMap) {
		...
		JComboBox<?> comboBoxFileType = new JComboBox<Object>(values);
...
//					}
	...
	private void setPanelJSON(JPanel panelHolder) {
		...
		comboBoxJsonSourceFile = new JComboBox<Object>();
		...
		btnOpenSource.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (!(filePath == null)) {
					...
					if (!filePath.equals("")) {
						DefaultComboBoxModel<Object> comboBoxModel = (DefaultComboBoxModel<Object>) comboBoxJsonSourceFile.getModel();
		...
		comboBoxJsonTargetType = new JComboBox<Object>(methods.getAllFileTypes().keySet().toArray());
		...
		comboBoxJsonTargetFile = new JComboBox<Object>();
		...
		btnOpenTarget.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (!filePath.equals("")) {
					...
					DefaultComboBoxModel<Object> comboBoxModel = (DefaultComboBoxModel<Object>) comboBoxJsonTargetFile.getModel();
					comboBoxModel.addElement(filePath);
	...
	private void setPanelXML(JPanel panelHolder) {
		...
		comboBoxXmlSourceFile = new JComboBox<String>();
		...
		btnOpenSource.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (!(filePath == null)) {
					...
					if (!filePath.equals("")) {
						DefaultComboBoxModel<String> comboBoxModel = (DefaultComboBoxModel<String>) comboBoxXmlSourceFile.getModel();
						comboBoxModel.addElement(filePath);
		...
		comboBoxXmlTargetType = new JComboBox<Object>(methods.getAllFileTypes().keySet().toArray());
		...
		comboBoxXmlTargetFile = new JComboBox<String>();
		...
		btnOpenTarget.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (!filePath.equals("")) {
					setXmlTarget(filePath);
					DefaultComboBoxModel<String> comboBoxModel = (DefaultComboBoxModel<String>) comboBoxXmlTargetFile.getModel();
					comboBoxModel.addElement(filePath);
	...
	private void setPanelExcel(JPanel panelHolder) {
		...
		comboBoxExcelSourceFile = new JComboBox<String>();
		...
		btnOpenSource.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (!(filePath == null)) {
					...
					if (!filePath.equals("")) {
						DefaultComboBoxModel<String> comboBoxModel = (DefaultComboBoxModel<String>) comboBoxExcelSourceFile.getModel();
						comboBoxModel.addElement(filePath);
		...
		comboBoxExcelTargetType = new JComboBox<Object>(methods.getAllFileTypes().keySet().toArray());
		...
		comboBoxExcelTargetFile = new JComboBox<String>();
		...
		btnOpenTarget.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (!filePath.equals("")) {
					...
					DefaultComboBoxModel<String> comboBoxModel = (DefaultComboBoxModel<String>) comboBoxExcelTargetFile.getModel();
					comboBoxModel.addElement(filePath);
	...
	private void setPanelCSV(JPanel panelHolder) {
		...
		comboBoxCSVSourceFile = new JComboBox<String>();
		...
		btnOpenSource.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (!(filePath == null)) {
					...
					if (!filePath.equals("")) {
						DefaultComboBoxModel<String> comboBoxModel = (DefaultComboBoxModel<String>) comboBoxCSVSourceFile.getModel();
						comboBoxModel.addElement(filePath);
		...
		comboBoxCSVDelimiter = new JComboBox<Object>(delimiters);
		...
		comboBoxCSVTargetType = new JComboBox<Object>(methods.getAllFileTypes().keySet().toArray());
		...
		comboBoxCSVTargetFile = new JComboBox<String>();
		...
		btnOpenTarget.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (!filePath.equals("")) {
					...
					DefaultComboBoxModel<String> comboBoxModel = (DefaultComboBoxModel<String>) comboBoxCSVTargetFile.getModel();
					comboBoxModel.addElement(filePath);
