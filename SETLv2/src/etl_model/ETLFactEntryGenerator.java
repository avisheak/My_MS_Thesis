...
public class ETLFactEntryGenerator implements ETLOperation {
	...
	public boolean getInput(JPanel panel, HashMap<String, LinkedHashSet<String>> inputParamsMap) {
		...
		JComboBox<?> comboBoxFileType = new JComboBox<Object>(types);
		...
		JComboBox<Object> comboBoxSourceCSV = new JComboBox<Object>();
		...
		btnOpenSourceCSV.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (!(filePath == null)) {
					DefaultComboBoxModel<Object> comboBoxModel = (DefaultComboBoxModel<Object>) comboBoxSourceCSV.getModel();
		...
		JComboBox<?> comboBoxDelimiter = new JComboBox<Object>(delimiters);
		...
		JComboBox<Object> comboBoxTargetTBox = new JComboBox<Object>();
		...
		btnOpenTargetTBox.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (!(filePath == null)) {
					DefaultComboBoxModel<Object> comboBoxModel = (DefaultComboBoxModel<Object>) comboBoxTargetTBox.getModel();
					comboBoxModel.addElement(filePath);
		...
		JComboBox<?> comboBoxTargetType = new JComboBox<Object>(methods.getAllFileTypes().keySet().toArray());
		...
		JComboBox<Object> comboBoxTargetABox = new JComboBox<Object>();
		setFont(comboBoxTargetABox);
		panelCSV.add(comboBoxTargetABox, "cell 1 6 2 1,growx");
		
		LinkedHashSet<String> hashSet = inputParamsMap.get(LEVEL_FILE);
		...
		btnOpenTargetABox.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (!filePath.equals("")) {
					DefaultComboBoxModel<Object> comboBoxModel = (DefaultComboBoxModel<Object>) comboBoxTargetABox.getModel();
					comboBoxModel.addElement(filePath);
		...
		JComboBox<Object> comboBoxSourceABox2 = new JComboBox<Object>();
		...
		btnOpenSourceABox2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String filePath = methods.chooseFile("Select Source ABox File");
				if (!(filePath == null)) {
					DefaultComboBoxModel<Object> comboBoxModel = (DefaultComboBoxModel<Object>) comboBoxSourceABox2.getModel();
					comboBoxModel.addElement(filePath);
		...
		JComboBox<Object> comboBoxTargetTBox2 = new JComboBox<Object>();
		...
		btnOpenTargetTBox2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String filePath = methods.chooseFile("Select Target TBox File");
				if (!(filePath == null)) {
					DefaultComboBoxModel<Object> comboBoxModel = (DefaultComboBoxModel<Object>) comboBoxTargetTBox2.getModel();
					comboBoxModel.addElement(filePath);
		...
		JComboBox<?> comboBoxTargetType2 = new JComboBox<Object>(methods.getAllFileTypes().keySet().toArray());
		...
		JComboBox<Object> comboBoxTargetABox2 = new JComboBox<Object>();
		...
		int confirmation = JOptionPane.showConfirmDialog(null, panelHolder,
				"Please Input Values for Fact Entry Generator.", JOptionPane.OK_CANCEL_OPTION);
		...
		if (confirmation == JOptionPane.OK_OPTION) {
			...
			if (getFileType().equals("CSV")) {
				...
				if (getSourceCSV() != null && getMappingFile() != null && 
					...
					inputParamsMap.get(FACT_FILE).add(getTargetABoxFile());
