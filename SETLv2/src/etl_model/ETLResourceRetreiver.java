...
public class ETLResourceRetreiver implements ETLOperation {
	...
	JComboBox<Object> comboBoxOperation, comboBoxDBpediaData, comboBoxRDFFile;
	...
	public boolean getInput(JPanel panel, HashMap<String, LinkedHashSet<String>> inputParamsMap) {
		...
		comboBoxOperation = new JComboBox<Object>();
		comboBoxOperation.setFont(new Font("Tahoma", Font.PLAIN, 16));
		comboBoxOperation.setModel(new DefaultComboBoxModel<Object>(new String[] { "DBpedia Resource Retriever",
		...
		comboBoxDBpediaData = new JComboBox<Object>();
		...
		ArrayList<?> dbpediaDataNameList = new ArrayList<>(dbPediaDataNameSet);
		...
		comboBoxRDFFile = new JComboBox<Object>();
		...
		comboBoxRDFFile.setModel(new DefaultComboBoxModel<Object>(rdfFilePathList.toArray()));
		...
		btnNewDBPediaDataFile.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if (!filePath.equals("")) {
					...
					DefaultComboBoxModel<Object> comboBoxModel = (DefaultComboBoxModel<Object>) comboBoxDBpediaData.getModel();
		...
		btnOpenRDF.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if (!filePath.equals("")) {
					...
					DefaultComboBoxModel<Object> comboBoxModel = (DefaultComboBoxModel<Object>) comboBoxRDFFile.getModel();
					comboBoxModel.addElement(filePath);
