...
public class ETLRDFWrapper implements ETLOperation {
	...
	private ArrayList allColumnNames; 
	private ArrayList<Object> selectedColumns;
	...
	public ArrayList<Object> getAllColumnNames() {
		return allColumnNames;
	}

	public void setAllColumnNames(ArrayList<Object> allColumnNames) {
...
//		panelRDFWrapper.setLayout(new BorderLayout(0, 0));
		...
		JComboBox<?> comboBox = new JComboBox<Object>(strings);
		...
		JComboBox<?> comboBoxCSVKeyAttribute = new JComboBox<Object>(keyAttributes);
		
		JComboBox<?> comboBoxCSVDelimiter = new JComboBox<Object>(delimiters);
		...
		JComboBox<?> comboBoxCSVTargetType = new JComboBox<Object>(methods.getAllFileTypes().keySet().toArray());
		...
		JComboBox<?> comboBoxXMLTargetType = new JComboBox<Object>(methods.getAllFileTypes().keySet().toArray());
		...
		JComboBox<?> comboBoxExcelKeyAttributeType = new JComboBox<Object>(keyAttributes);
		...
		JComboBox<?> comboBoxExcelTargetType = new JComboBox<Object>(methods.getAllFileTypes().keySet().toArray());
		...
		JComboBox<?> comboBoxJsonTargetType = new JComboBox<Object>(methods.getAllFileTypes().keySet().toArray());
		...
		JComboBox<?> comboBoxType = new JComboBox<Object>(types);
	...
	public ArrayList<Object> getSelectedColumns() {
		return selectedColumns;
	}

	public void setSelectedColumns(ArrayList<Object> selectedColumns) {
